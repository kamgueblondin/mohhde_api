...
class Projet(models.Model):
    ...
    nombre_vues = models.IntegerField(default=0,null=True)
    note_expert = models.DecimalField(max_digits=10, decimal_places=2, null=True)
    appreciation_projet = models.DecimalField(max_digits=10, decimal_places=2, null=True)
    echeance = models.DateField()
    expert = models.ForeignKey(User, related_name='expert_qui_suit_projet', on_delete=models.SET_NULL, null=True)
